...
const EmployeesCorner = () => {
  const { heroTitle, heroSubtitle } = useContent("employees_corner");
        ...
        <section className="py-8 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-8">
              <h1 className="font-heading font-bold text-4xl md:text-5xl mb-4 text-gradient bg-gradient-to-r from-primary to-blue-500 bg-clip-text text-transparent animate-fade-in">
                {heroTitle}
              </h1>
                  ...
                  <div className="sticky top-24">
                    <Card className="border-none shadow-xl bg-white rounded-2xl">
                      <CardContent className="p-6">
                        <h3 className="text-xl font-bold mb-4 text-gray-900 border-b border-blue-200 pb-3">
                          All Articles
                        </h3>
