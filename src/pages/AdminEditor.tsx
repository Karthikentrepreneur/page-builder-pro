...
import { Upload, Save, LogOut, Edit, Trash2, Plus, Briefcase, FileText, Layout } from "lucide-react";
...
const AdminEditor = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-white to-sky-50">
      <Header />
            ...
            <TabsContent value="articles">
              <div className="flex justify-between items-center mb-8">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-primary to-blue-500 hover:from-blue-600 hover:to-sky-600 flex items-center gap-2"
                >
